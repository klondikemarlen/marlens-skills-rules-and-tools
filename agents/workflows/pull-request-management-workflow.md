...
- Write PR titles in title case. Read the first available title casing reference: local `agents/references/title-casing-reference.md`, then packaged `skill://pull-request-management/title-casing-reference.md`.
