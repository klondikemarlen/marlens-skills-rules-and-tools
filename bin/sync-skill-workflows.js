...
const mirrors = {
  ...
  "express-light-rail": ["express-light-rail-backend-workflow.md"],
  feature: ["feature-workflow.md"],
  "git-rebase": ["git-rebase-workflow.md"],
  learn: ["learn-workflow.md"],
  "node-express-api": ["node-express-api-workflow.md", "express-light-rail-backend-workflow.md"],
