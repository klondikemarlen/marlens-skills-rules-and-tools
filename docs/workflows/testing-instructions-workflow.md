...
- For asynchronous integration tests, use [Real Async Runtime Barriers in Integration Tests](../references/engineering-techniques-reference.md#real-async-runtime-barriers-in-integration-tests): name the observable condition and unique marker instead of prescribing a delay.
