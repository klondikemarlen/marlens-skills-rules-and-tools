...
See [Safe Worktree Cleanup in Dockerized Projects](../references/engineering-techniques-reference.md#safe-worktree-cleanup-in-dockerized-projects) for ownership and safety boundaries.
