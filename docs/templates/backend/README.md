...
Reusable backend implementation templates live here. Keep framework-specific families in subdirectories when a pattern depends on a particular route/controller/service/model stack.
