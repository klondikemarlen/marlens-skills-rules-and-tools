...
- Reuse [`code-organization-reference.md`](../../docs/references/code-organization-reference.md) for vocabulary and pattern-fit criteria, and use the outcome-first-planning workflow when the design has unresolved tradeoffs.
