...
- For maintainability or organization findings, use the packaged `../../docs/references/code-organization-reference.md` reference when no local equivalent exists: flag boundaries, modules, helpers, or abstractions only when they affect ownership, data handoffs, dependency direction, side effects, or future change safety. Keep Ponytail/YAGNI simplicity checks separate.
