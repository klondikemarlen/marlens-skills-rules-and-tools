...
Read the authoritative reference when it is available. This packaged file is only a thin `skill://pull-request-management/title-casing.md` fallback for agents that cannot directly read the package-level `agents/` reference.
