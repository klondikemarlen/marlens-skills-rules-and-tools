...
- Write PR titles in title case. Read the first available title casing reference: local `agents/references/title-casing-reference.md`, then the current runtime packaged fallback: OMP `skill://pull-request-management/title-casing.md` or Claude Code `${CLAUDE_SKILL_DIR}/title-casing.md`.
