...
- Use project-local templates from `agents/templates/backend/express-light-rail/` when they exist; otherwise continue from this workflow and nearby live code.
...
2. If the project has `agents/templates/backend/express-light-rail/`, pick only the templates needed; otherwise use nearby live code and this workflow as the fallback shape.
